! function() {
    ...
    ! function() {
        ...
        e.forEach((e => {
            ...
            }(e), e.dataset.playbackRate && (e.playbackRate = parseFloat(e.dataset.playbackRate) || 1);
            const a = {},
                {
            ...
            const l = null !== (o = e.closest(".video_container")) && void 0 !== o ? o : (null !== (i = e.closest("svg")) && void 0 !== i ? i : e).closest("div"),
                {
                    ...
                    i.updateDuration = d, r.appendChild(s),
                        function(e, t) {
                    ...
                    r.addEventListener("mouseenter", m), r.addEventListener("mouseover", m), r.addEventListener("mousemove", m), r.addEventListener("mouseleave", g), r.addEventListener("mouseout", g), r.addEventListener("click", c);
                    const y = () => {
